...
class MainApp(ttk.Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.scan_status_label.pack(fill="x", pady=5, side="top", anchor="n")        # Header and calendar below controls
    ...
    def toggle_scanning(self):
        ...
        if self.toggle_var.get():
            ...
            messagebox.showinfo("Auto-Scanning", "Auto-scanning disabled.")    def start_countdown(self):
        """
    ...
    def next_month(self):
        ...
        self.refresh_calendar()    def refresh_calendar(self):
        """
